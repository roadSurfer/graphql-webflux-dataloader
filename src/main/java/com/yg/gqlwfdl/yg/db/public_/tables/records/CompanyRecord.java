...
public class CompanyRecord extends UpdatableRecordImpl<CompanyRecord> implements Record4<Long, String, String, Long> {

    private static final long serialVersionUID = 607378977;
     ...
     */
    @Override
    public CompanyRecord values(Long value1, String value2, String value3, Long value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CompanyRecord(Long id, String name, String address, Long primaryContact) {
        super(Company.COMPANY);
