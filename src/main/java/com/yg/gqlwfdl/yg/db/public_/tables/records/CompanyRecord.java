...
public class CompanyRecord extends UpdatableRecordImpl<CompanyRecord> implements Record3<Long, String, String> {

    private static final long serialVersionUID = 1902773154;
     ...
     */
    @Override
    public CompanyRecord values(Long value1, String value2, String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public CompanyRecord(Long id, String name, String address) {
        super(Company.COMPANY);
